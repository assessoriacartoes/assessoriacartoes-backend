...
{
    public class VendaG5SMARTMap : IEntityTypeConfiguration<VendaG5SMART>
    {
        void IEntityTypeConfiguration<VendaG5SMART>.Configure(EntityTypeBuilder<VendaG5SMART> builder)
        {
