...
{
    public class VendaEASSESSORIAMap : IEntityTypeConfiguration<VendaEASSESSORIA>
    {
        void IEntityTypeConfiguration<VendaEASSESSORIA>.Configure(EntityTypeBuilder<VendaEASSESSORIA> builder)
        {
