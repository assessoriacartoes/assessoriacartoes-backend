...
{
    public class FinanceiroG5SMARTMap : IEntityTypeConfiguration<FinanceiroG5SMART>
    {
        void IEntityTypeConfiguration<FinanceiroG5SMART>.Configure(EntityTypeBuilder<FinanceiroG5SMART> builder)
        {
